        ...
        if (event == "telemetry") {
          // j[1] is the data JSON object
            ...
            lanes.clear();
          	...
          	{
                vector<double> car;
                //cout << "car " << sensor_fusion << endl;
          	    double car_id = sensor_fusion[i][0];
                double car_x_pos = sensor_fusion[i][1];
                double car_y_pos = sensor_fusion[i][2];
                ...
                check_car_s += (double)prev_size*sampling_N*check_speed;

                car.push_back(car_id);
                car.push_back(car_x_pos);
                car.push_back(car_y_pos);
                car.push_back(vx);
                car.push_back(vy);
                car.push_back(check_speed);
                car.push_back(check_car_s);
                car.push_back(d);
                car.push_back(check_car_s-car_s);

                // segment cars into 3 lanes
                for (int l=0; l<3; l++) {
                    if (d < (4+4*l) && d > (4*l))
                    {
                        lanes[l].push_back(car);
                        //cout << "car " << car_id << " in lane " << l << endl;
                    }
                }
            ...
            for (int l=0; l<3; l++) {
                cout << "cars in lane " << l << ": ";
                for (int k = 0; k < lanes[l].size(); k++) {
                    cout << lanes[l][k][0] << " - " << lanes[l][k][8] << "m, ";
                }
                cout << endl;
            }
